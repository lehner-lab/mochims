...
#' @param suffix suffix for output files (required)
#' @param highlight_colour colour for highlights (default:red)
#'
#' @return Nothing
#' @export
#' @import data.table
mochims__plot_model_performance <- function(
  input_dt,
  report_outpath,
  suffix,
  ...
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_mutorderfacet_model1.pdf")), d, width = 15, height = 9, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(observed_fitness, predicted_fitness)) +
    ...
    ggplot2::theme_classic()
  d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_model1.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(observed_fitness, predicted_fitness)) +
    ...
    ggplot2::theme_classic()
  d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_allmodels_test.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(observed_fitness, predicted_fitness)) +
    ...
    ggplot2::theme_classic()
  d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_allmodels_test_nolog.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(observed_fitness, predicted_fitness)) +
    ...
    ggplot2::theme_classic()
  d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_allmodels_test_highres.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(observed_fitness, predicted_fitness)) +
    ...
    ggplot2::theme_classic()
  d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_observed_predicted_scatter_", suffix, "_allmodels_test_highres_nolog.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
  ...
  d <- ggplot2::ggplot(plot_dt,ggplot2::aes(predicted_fitness, residual_fitness)) +
    ...
    ggplot2::theme_classic()
  # d <- d + ggplot2::geom_abline(linetype = 2)
  ggplot2::ggsave(file.path(report_outpath, paste0("fitness_residuals_predicted_scatter_", suffix, "_allmodels_test.pdf")), d, width = 4, height = 3, useDingbats=FALSE)
