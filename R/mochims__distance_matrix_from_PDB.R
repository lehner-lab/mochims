...
#' mochims__distance_matrix_from_PDB
#'
...
#' @export
#' @import data.table
mochims__distance_matrix_from_PDB <- function(
	input_file,
	residue_subset="all",
	query_chain="A",
	metric="scHA"
	...
	#Distance matrix
	dist_mat <- mochims__pairwise_distances_from_PDB(
		input_file, 
	...
	dist_dt[, Pos1 := residue_subset[Pos1]]
	dist_dt[, Pos2 := residue_subset[Pos2]]
